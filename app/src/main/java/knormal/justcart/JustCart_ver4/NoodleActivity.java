...
public class NoodleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_shop = findViewById(R.id.btn_shop10);
        btn_home = findViewById(R.id.btn_home10);
        btn_mypage = findViewById(R.id.btn_mypage10);
        ...
        btn_shop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NoodleActivity.this, ShopActivity2.class);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NoodleActivity.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            }
        ...
        btn_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if(SharedPreference.getUserName(NoodleActivity.this).length() == 0) {

                    Intent intent = new Intent(NoodleActivity.this, LoginActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    ...
                    Intent intent = new Intent(NoodleActivity.this, MypageActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("STD_NUM", SharedPreference.getUserName(NoodleActivity.this).toString());
                    startActivity(intent);
                    finish();
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(NoodleActivity.this,
