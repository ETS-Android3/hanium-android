    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_shop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Fruit.this, ShopActivity2.class);
        ...
        btn_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if(SharedPreference.getUserName(Fruit.this).length() == 0) {
                    Intent intent = new Intent(Fruit.this, LoginActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                } else {
                    Intent intent = new Intent(Fruit.this, MypageActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("STD_NUM", SharedPreference.getUserName(Fruit.this).toString());
                    startActivity(intent);
                    finish();
                }
            }
